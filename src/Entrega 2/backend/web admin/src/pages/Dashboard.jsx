    ...
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden' }}>
      ...
      <aside style={{ 
        ...
        <nav style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
          ...
          {/* NOVA ABA: GESTÃO DE ACESSOS (PROFISSIONAIS) */}
          <div style={{ marginTop: '16px', paddingTop: '16px', borderTop: '1px solid rgba(255,255,255,0.1)' }}>
            ...
            <Link to="/dashboard/configuracoes/usuarios" style={location.pathname.startsWith('/dashboard/configuracoes/usuarios') ? activeStyle : inactiveStyle}>
              <ShieldCheck size={20} /> Gestão Admin
            </Link>
          </div>
